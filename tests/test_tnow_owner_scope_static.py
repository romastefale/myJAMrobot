...
def test_universal_songcharts_executor_rechecks_owner():
    assert "WEB_UNIVERSAL_SONGCHARTS_REJECTED_NON_OWNER" in RUNNER
    assert "Songcharts universal é exclusivo do dono do código." in RUNNER
